...
public class MemberReview {
    ...
    public int calcAverageAge(List<Member> a) { //list<Member>라는 형식을 쓴 것임 원래는String있잖아 그니까 그것처럼 Member라는게 있는거야 그리고 새로운 변수 a잡기
        int listLengthSum = 0;
        int listLengthAverage =0;
        int listLength = a.size();
        for (Member e : a) { //이것은 String 형태가 아니라 Member 형식이다
    ...
    public int howManyMembersWithLastName(List<Member> a) {
    ...
    public double calcAverageIdChar(List<Member> a) {
